...
namespace ASP_MVC
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<IRecetteRepository<BLL.Entities.Recette>, BLL.Services.RecetteService>();
            builder.Services.AddScoped<IRecetteRepository<DAL.Entities.Recette>, DAL.Services.RecetteService>();
